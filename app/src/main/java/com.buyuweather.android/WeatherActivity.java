...
import com.buyuweather.android.gson.Forecast;
import com.buyuweather.android.gson.Weather;
import com.buyuweather.android.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT>=21){
            ...
            decorView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN
                |View.SYSTEM_UI_FLAG_LAYOUT_STABLE);//设置状态栏的布局
        ...
        if (weatherString!=null){
            ...
            //如果没有缓存数据，就接收从上个页面传来的weather_id参数，然后去服务器查询
    ...
    public void requestWeather(final String weatherId){
        ...
        HttpUtil.sendOKHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    //如果成功查询到了数据，将数据存入sharedpreference变量并且显示出来
                    @Override
                    public void run() {
    ...
    private void showWeatherInfo(Weather weather){
        ...
        String updateTime=weather.basic.update.UpdateTime.split(" ")[1];//显示具体的时间，0为日期
